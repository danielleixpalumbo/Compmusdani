...
In contrast, the timbre-based matrix makes this alternation much more visible, as the switch to the different part of the song is highlighted by the presense or the absence of certain instruments: the verse is charachterised by the well-known double bass riff, while in the chorus only voices and drums are present.